// var isUserReal = require("../useFirebase.js");

import isUserReal from "../useFirebase.js";
...
function getChatName(msg) {
  var members = msg.data.members;
  for (var member of members) {
    if (!isUserReal(member)) return false;
  }
}
...
export function send(connection, type, data) {
  try {
