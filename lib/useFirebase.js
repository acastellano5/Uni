  ...
  try {
    ...
    if (roleFilter=="Student") {
      ...
      if (conditions[0]) {
        ...
        queryArray.push(where(`orgs.${orgId}.class`,'==',conditions[0]))
      ...
      if (conditions[2]) {
        ...
        queryArray.push(where(`orgs.${orgId}.groups`,'==',conditions[2]))
    ...
    if (roleFilter=="Alumni") {
      ...
      if (conditions[2]) {
        console.log(conditions[2]);
        queryArray.push(where(`orgs.${orgId}.State`,'==',conditions[2]))

      }
      if (conditions[3]) {
        console.log(conditions[3]);
        queryArray.push(where(`orgs.${orgId}.Field`,'==',conditions[3]))

      }
      if (conditions[4]) {
        console.log(conditions[4]);
        queryArray.push(where(`orgs.${orgId}.College`,'==',conditions[4]))
