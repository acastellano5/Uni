...
const ChatName = ({ name, profileName }) => {
  ...
  return (
    <TouchableOpacity className="flex-row items-center justify-center" onPress={() => {if(profileName == "aiChat"){handleClick()} else if (typeof(profileName) == "object") { alert(profileName.join(', ')) } else if (profileName) { router.push({
