...
import { interestsData, classData, activitiesData } from "../../assets/data"
...
const StudentFilter = () => {
  ...
  return (
    ...
    <View className="w-11/12 mx-auto mb-5">
        ...
        <MultiSelectDropDown title="Clubs/Activites" placeholder="Filter by Clubs/Activities" data={activitiesData}/>  
    </View>
