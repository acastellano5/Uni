...
import { interestsData, classData, departmentsData, activitiesData } from "../../assets/data/filter"
...
const FacultyFilter = () => {
  ...
  return (
    ...
    <View className="w-11/12 mx-auto mb-5">
        <SingleSelectDropdown filterCategory="Department" data={departmentsData}/>
